...
const WorkItem = memo(({ item, index }: { item: WorkItem; index: number }) => (
  <article
  ...
  >
    <div className="relative w-full aspect-video mb-6 overflow-hidden rounded-2xl shadow-lg group-hover:shadow-2xl transition-shadow duration-500">
      <img
        src={item.image}
        alt={item.alt}
  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
        <div className="absolute top-0 right-0 w-1/2 h-1/2 bg-gradient-to-bl from-blue-600/10 to-transparent rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-0 w-1/2 h-1/2 bg-gradient-to-tr from-purple-600/10 to-transparent rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="text-center animate-fade-in-up" style={{ animationDelay: '0.5s', animationFillMode: 'both' }}>
          <button
            ...
            className="inline-flex items-center gap-3 text-white font-semibold text-lg 
