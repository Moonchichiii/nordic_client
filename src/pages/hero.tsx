...
const ScrollIndicator = lazy(() => Promise.resolve({
  default: () => (
    <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce" aria-hidden="true">
      <div className="w-6 h-10 border-2 border-slate-400/60 dark:border-slate-400/60 rounded-full flex justify-center">
        <div className="w-1 h-3 bg-slate-400/80 dark:bg-slate-400/80 rounded-full mt-2 animate-pulse" />
      </div>
    </div>
  )
}))
...
const animateLogoText = (element: string | Element, delay: number = 0) => {
  gsap.fromTo(element,
    {
      opacity: 0,
      y: 80,
...
const animateSubtitle = (element: string | Element, delay: number = 0) => {
  gsap.fromTo(element,
    {
      opacity: 0,
      y: 40,
...
const animateButtons = (elements: Element[], delay: number = 0) => {
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
        <div
          className="absolute top-1/4 right-1/3 w-[clamp(20rem,40vw,50rem)] h-[clamp(20rem,40vw,50rem)]
                     ...
                     dark:from-blue-600/30 dark:to-purple-600/25"
        />
        <div
          className="absolute bottom-1/3 left-1/4 w-[clamp(16rem,30vw,40rem)] h-[clamp(16rem,30vw,40rem)]
                     ...
                     dark:from-purple-600/25 dark:to-blue-600/20"
        />
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2
                     ...
                     dark:from-blue-500/15 dark:via-purple-500/10 dark:to-transparent"
        />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center min-h-[80vh]">
          ...
          <div className="lg:col-span-8 text-center lg:text-left">
            <h1 className="font-heading tracking-tighter mb-6 lg:mb-8">
              <span
                ref={nordicRef}
                className="block text-7xl md:text-8xl lg:text-9xl xl:text-[10rem] font-black 
                         text-white dark:text-white opacity-0 transition-colors duration-700"
                style={{
              ...
              <span
                ...
                className="block text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black
                         ...
                         dark:from-blue-400 dark:via-purple-400 dark:to-blue-500
                         bg-clip-text text-transparent opacity-0 transition-all duration-700"
                style={{
            ...
            >
              <p className="text-xl md:text-2xl lg:text-3xl font-medium 
                         text-slate-300 dark:text-slate-300 leading-relaxed max-w-2xl mx-auto lg:mx-0
                         transition-colors duration-700">
                Digital experiences with{' '}
                <span className="font-bold bg-gradient-to-r from-blue-400 to-purple-400 
            ...
            >
              ...
              <button
                ...
                className="w-full px-8 py-4 glass border-2 border-slate-600/30
                         hover:bg-white/10 hover:border-slate-500/50 
                         dark:hover:bg-white/20 dark:hover:border-slate-400/50
